...
void Principal::dibujar()
{
    ...
    painter.drawRect(x+195, y+50+incYN2, 100, altoN2);
    ...
    //Dibujar el plano cartesiano X
    painter.drawLine(x+25,y+450, x+475, y+450);

    //Dibujar el plano cartesiano Y
    painter.drawLine(x+50,y+50, x+50,y+475);

    //Dibujar lineas
    painter.drawLine(x+50,y+400, x+50,y+400);


    // Dibujar nombres
    painter.drawText(x+115,y+470, "N1");
    painter.drawText(x+235,y+470, "N2");
    painter.drawText(x+355,y+470, "N3");
    ...
    for (int i=0; i<=5; i++){
        cont = cont-83;
        qDebug()<<as<<""<<cont;
        painter.drawText(15, cont, QString::number(as));
        as = as+(5*4);
    }
